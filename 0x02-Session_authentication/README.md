...
**Files - `api/v1/app.py`, `api/v1/views/users.py`:**
...
**Files - `api/v1/views/session_auth.py`, `api/v1/views/__init__.py`:**
...
**Files - `api/v1/auth/session_auth.py`, `api/v1/views/session_auth.py`:**
...
**Files - `api/v1/auth/session_exp_auth.py`, `api/v1/app.py`:**
...
**Files - `api/v1/auth/session_db_auth.py`, `api/v1/app.py`, `models/user_session.py`:**
